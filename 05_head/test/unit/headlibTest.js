...
var lib = require('../../src/headlib.js').lib;
var test = {};
exports.test = test;
...
test ["find invalid flags from array."] = function(){
	...
	assert.deepEqual(["-c"],lib.findInValidFlag(["--bytes20","-c20","-c","--by20"]));
};
...
test ["adjust the space between flag and digit"] = function(){
	assert.deepEqual(["-lines10","10","10","-q","10","10","10","-v","10","-byte10"],lib.adjustSpace(["-lines10","10","10","-q","10","10","10","-v","10","-byte","10"]));
	assert.deepEqual(["-lines10","10","-q","10","10","10","-v","10","-byte10"],lib.adjustSpace(["-lines","10","10","-q","10","10","10","-v","10","-byte","10"]));
	assert.deepEqual(["-lines10","10","-q","10"],lib.adjustSpace(["-lines","10","10","-q","10"]));
};
